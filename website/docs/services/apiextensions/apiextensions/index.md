...
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.apiextensions.apiextensions" /></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| <CopyableCode code="getApiextensionsAPIGroup" /> | `SELECT` | <CopyableCode code="cluster_addr, protocol" /> |
