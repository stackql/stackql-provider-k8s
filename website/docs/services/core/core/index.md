...
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.core.core" /></td></tr>
</tbody></table>
...
| <CopyableCode code="versions" /> | `array` | versions are the api versions that are available. |
## Methods
| Name | Accessible by | Required Params |
|:-----|:--------------|:----------------|
| <CopyableCode code="getCoreAPIVersions" /> | `SELECT` | <CopyableCode code="cluster_addr, protocol" /> |
